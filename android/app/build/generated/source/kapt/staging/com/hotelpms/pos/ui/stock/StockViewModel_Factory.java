...
public final class StockViewModel_Factory implements Factory<StockViewModel> {
  ...
  public StockViewModel_Factory(Provider<PmsApiService> apiProvider,
  ...
  public static StockViewModel_Factory create(Provider<PmsApiService> apiProvider,
      Provider<TokenManager> tokenManagerProvider) {
    return new StockViewModel_Factory(apiProvider, tokenManagerProvider);
  }

  public static StockViewModel newInstance(PmsApiService api, TokenManager tokenManager) {
    return new StockViewModel(api, tokenManager);
  }
}
